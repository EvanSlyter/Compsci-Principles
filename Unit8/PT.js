...
function gameTime(){
  ...
  for(var k=1;k<31;k++){
    ...
    setProperty("Asteroid"+k,"image","icon://fa-asterisk");
  }
  setProperty("GameScreen","background-color",rgb(75, 82, 107));
  ...
  timedLoop(100,function(){
    ...
    if((getYPosition("Asteroid"+j)>420)&&(getProperty(("Asteroid"+j),"hidden")==false)){
...
onEvent("optionsButton","click",function(){
  ...
  for(var un=1;un<31;un++){
    if((getProperty("Asteroid"+un,"icon-color")=="White")&&(getProperty("player","icon-color")=="red")&&getProperty("player","image")=="icon://fa-heart"){
      setProperty("Asteroid"+un,"image","bone.png");
      setProperty("GameScreen","background-color","black");
    }
...
onEvent("nameButton","click",function(){
  ...
  insertItem(nameList,0,playerName);
